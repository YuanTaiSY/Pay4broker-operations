...
const COMP_DATA={
  DP:{
    'Pay4Broker': [932, 854, 720, 485, 775, 1195, 472, 723, 809],
    'ChipPay': [565, 1055, 1581, 1340, 1442, 4202, 2056, 2219, 2112],
    'FaPay': [222, 207, 210, 13, 239, 465, 214, 0, 0],
    'MyPay': [179, 229, 156, 224, 140, 45, 2, 18, 22],
    'SLpayment': [0, 0, 0, 0, 0, 0, 0, 268, 181],
    'Xpay': [0, 0, 0, 0, 0, 0, 0, 223, 157],
    'ANXPay': [32, 75, 27, 23, 86, 67, 11, 5, 4],
    'Exlink': [5, 45, 23, 15, 45, 67, 31, 22, 4],
  },
  CG:{
    'Pay4Broker': [38, 76, 25, 33, 53, 144, 29, 99, 99],
